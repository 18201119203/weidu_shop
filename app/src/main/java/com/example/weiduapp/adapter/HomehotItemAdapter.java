...
public class HomehotItemAdapter extends RecyclerView.Adapter<HomehotItemAdapter.ViewHolder> {

    private List<HomeItemShopBean.ResultBean.listBean.CommodityListBean> list;
    private Context context;

    public HomehotItemAdapter(Context context, List<HomeItemShopBean.ResultBean.listBean.CommodityListBean> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.homehotshopitemitem, parent, false);
