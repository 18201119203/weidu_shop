...
public class HomestyleItemAdapter extends RecyclerView.Adapter<HomestyleItemAdapter.ViewHolder> {

    private List<HomeItemShopBean.ResultBean.listBean.CommodityListBean> list;
    private Context context;

    public HomestyleItemAdapter(Context context, List<HomeItemShopBean.ResultBean.listBean.CommodityListBean> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.homestyleshopitemitem, parent, false);
